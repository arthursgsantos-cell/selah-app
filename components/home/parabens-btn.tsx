 ...
 * caminho inteiro cabe num toque, e o texto é curto de propósito: é ponto de
 * partida para a pessoa completar, não um cartão pronto que todo mundo manda
 * igual.
 */
export function ParabensBtn({
  ...
  const texto = encodeURIComponent(
    `Feliz aniversário, ${primeiroNome}! 🎉 Que Deus abençoe muito este seu novo ano de vida.` +
      (igrejaNome ? ` Um abraço da ${igrejaNome}!` : '')
  )
