...
import { CheckCircle2, ClipboardList, X, ExternalLink } from 'lucide-react'
...
export function InscricaoSection({
  ...
  // Link externo (Google Forms, Typeform, etc.) — o app não acompanha quem respondeu
  if (tipoInscricao === 'link' && linkUrl) {
    return (
      <a
        href={linkUrl}
        target="_blank"
